# -*- coding: utf-8 -*-
# Generated by Django 1.11.16 on 2018-12-25 13:31
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('open_date', models.DateTimeField(verbose_name='优惠券领取开始时间')),
                ('close_date', models.DateTimeField(verbose_name='优惠券领取结束时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coupon', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shopping.Coupon')),
            ],
            options={
