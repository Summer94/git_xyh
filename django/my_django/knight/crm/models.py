...
class Customer(models.Model):
    ...
    def __str__(self):
        return "{}-{}-{}".format(self.qq, self.qq_name, self.name)
    ...
    def show_course_list(self):
        return self.get_course_display().replace(","," | ")
    ...
    def show_status(self):
        stastus_color = {
            ...
            "unregistered": "red",
            "studying": "green",
            "paid_in_full": "skyblue",
        }
        return mark_safe("<span style='background-color: {};color: white'>{}</span>".format(stastus_color[self.status],
